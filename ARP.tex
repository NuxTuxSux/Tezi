...
Pertanto sar\`a sufficiente mostrare che $\Gamma_J\subseteq \Gamma_{\Phi_J}$ agisce anch'esso transitivamente su $X$ per concludere l'uguaglianza tra
i due sottogruppi.\\
%[PROSEGUIRE]
\end{proof}
