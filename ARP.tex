...
\quad F\longmapsto F^\Sigma
\end{equation*}
prende il nome di \emph{proiezione canonica}
\end{defin}
Cominciamo a vedere di che propriet\`a gode il quoziente, essendo a priori semplicemente un poset.
\begin{prop}
\label{prop:QuotientP1P2}
Sia $\p$ un $n$-politopo e $\Sigma\leq\Gamma(\p)$ un sottogruppo di sue simmetrie. Allora il poset quoziente $\p/\Sigma$ gode degli assiomi $(P1)$ e $(P2)$
...
\end{equation*}
una bandiera di $\p/\Sigma$ e $F_i^\Sigma<F_{i+1}^\Sigma$, allora esistono $\phi,\psi\in\Sigma$ tali che $F_i^\phi<F_{i+1}^\psi$ o
$F_i<F_{i+1}^{\psi\phi^{-1}}$[CONTINUARE]
