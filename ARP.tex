...
\end{equation*}
\end{defin}
Inoltre spesso sottindenderemo la scelta di una bandiera $\Phi$ di $\p$ che diremo \emph{di base} e quindi ci riferiremo ai generatori scelti
relativi a $\Phi$ con la pi\`u breve espressione \emph{generatori scelti}
\begin{prop}
...
Sia $\p$ un $n$-politopo regolare, $\Phi,\Psi\in\flag{\p}$ due bandiere e $(\phi_i)_{i=0}^{n-1}, (\psi_i)_{i=0}^{n-1}$ i loro rispettivi sistemi di
