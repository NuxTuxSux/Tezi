...
\begin{equation*}
\Gamma_{j\leftarrow k}:=\langle\phi_{j+1},\cdots,\phi_{k-1}\rangle=\Gamma_{\{j+1,\dots,k-1\}}
\end{equation*}
se $k-j\geq 2$ e
\begin{equation*}
\Gamma_{j\leftarrow k}:=\{1\}
\end{equation*}
altrimenti
\end{defin}
\begin{oss}
...
\end{proof}
Inoltre quello che ci servir\`a nel prossimo teorema \`e la seguente osservazione.
\begin{oss}
...
Siano $0\leq j\leq i\leq n-1$ ($\Phi=\{F_i\}_{i=0}^{n-1}$ la bandiera di base e $(\phi_i)_{i=0}^{n-1}$ i suoi generatori scelti) 
