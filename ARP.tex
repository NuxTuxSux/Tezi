...
quindi una struttura che prende il nome di \emph{prepolitopo}. I naturali e pi\`u usati morfismi tra prepolitopi sono le \emph{rap-map}.
...
di $\mathcal{G}$. Per sfruttare l'ipotesi di connessione (per bandiere) di $G$ estendiamo $\{G\}$ a una bandiera $\Psi\in\flag{\mathcal{G}}$. Avremo
quindi che esisteranno ranghi $-1<r_0\leq\cdots\leq r_l<n$ tali che
\begin{equation*}
0
\end{equation*}
\end{proof}
