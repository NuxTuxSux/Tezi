...
\begin{equation*}
\phi(\p)=\phi(\p/F_{-1})=\phi(\p)/\phi(F_{-1})=\mathcal{Q}/G_{-1}=\mathcal{Q}
\end{equation*}
...
[PROBLEMA DI NOTAZIONE] in quanto $\phi(F/F_{-1})=\phi(F)/G_{-1}=H/G_{-1}$, pertanto sia $G\leq F\in\p$ tale che $\phi(G)=K$.\\
