In questo capitolo parleremo dei politopi astratti, un'astrazione assiomatica 
...
% politopo = inviluppo convesso di un insieme finito di punti
% politopo ha dimensione k se il suo inviluppo affine ha dimensione k
% poligono = politopo di dimensione 2
% poliedro = politopo di dimensione 3
...
\begin{itemize}
\item m_{ii} = 1
\item m_{ij} = m_{ji} \geq 2 for $1 \leq i < j \leq k$
\end{itemize}
\end{def}
